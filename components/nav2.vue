			...
			<TooltipProvider :disabled="!collapsed" :delay-duration="150">
				<Tooltip>
					<TooltipTrigger as-child>
						<Collapsible
							:open="!page.isCollapsed"
							class="w-full px-2"
						>
							<Button
								variant="ghost"
								class="mt-2 flex h-6 w-[80%] items-center justify-between space-x-4 rounded-lg px-4 font-normal"
								:class="
									currentPageInfo.uid.split('-')[0] ==
									page.uid
										? 'bg-white font-bold text-primary dark:bg-border dark:text-white'
